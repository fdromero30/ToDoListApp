...
fdescribe('CrudUsuariosDetalleComponent', () => {
    let component: CrudUsuariosDetalleComponent;
    let fixture: ComponentFixture<CrudUsuariosDetalleComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(CrudUsuariosDetalleComponent);
